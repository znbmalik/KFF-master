...
#folder='../../my_data/UCF50-Brox/UCF50-Flow/flow/jpg/'
#outputfolder='../../my_data/UCF50-Brox/UCF50-KeyFlow_15/flow/jpg/'
folder='../../my_data/UCF50_flowNet/UCF50-Flow/flow/jpg/'
outputfolder='../../my_data/UCF50_flowNet/UCF50-KeyFlow_15/flow/jpg/'
...
def compareHSV(bar0, bar1, a_margin=0, nc_margin=0, m_margin=0):
    ...
    for b in bar1:
        ...
        if flag==False:#new color not in range of any exiting color
            #print(b[0] > nc_margin  and b[2] > m_margin)

            #if b[0] > nc_margin  or b[2] > m_margin:
            if b[0] > nc_margin  and b[2] > m_margin:#modified or->and
                #print(b[0])
                #print(b[2])
    ...
    '''for b in bar0:
        ...
        if flag1==False:#new color not in range of any exiting color
            #print(b[0] > nc_margin  and b[2] > m_margin)
            #if b[0] > nc_margin or b[2] > m_margin:
            if b[0] > nc_margin and b[2] > m_margin:
                #print(b[0])
                #print(b[2])
                newColor.append(b)'''
    return newColor
